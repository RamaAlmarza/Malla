document.addEventListener('DOMContentLoaded', () => {
    ...
    function toggleCompleted(id) {
        ...
        // **CLÁUSULA DE GUARDA (LÓGICA MEJORADA)**
        // Si la materia NO está disponible para cursar Y TAMPOCO está ya completada,
        // la función se detiene aquí y no hace nada.
        if (!isAvailable && !isCompleted) {
            return; 
        }

        // Si el código llega a este punto, significa que la materia es clickeable.
